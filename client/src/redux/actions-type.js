...
export const SET_PAGE_POKEMONS = "SET_PAGE_POKEMONS";
export const GET_BY_NAME = "GET_BY_NAME";

export const GET_ALL_TYPES = "GET_ALL_TYPES"
export const FILTER_TYPES = "FILTER_TYPES";
export const ASCENDENTE_POKEDEX = "ASCENDENTE_POKEDEX";
export const DESCENDENTE_POKEDEX = "DESCENDENTE_POKEDEX";
